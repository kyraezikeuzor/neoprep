...
export default function JoinBootcampClient({
    ...
    return (
      <div className="text-center">
        ...
        <p className="mt-4 text-sm leading-relaxed text-[#71717A]">
          To view your bootcamp homework, click Assignments in the sidebar.
        </p>
        <Link
          href="/assignments"
      ...
      <div className="text-center">
        ...
        <p className="mt-2 text-base text-[#71717A]">
          {joining
            ...
            : "Finish joining to unlock your assignments."}
        </p>
        {error ? (
          <div className="mt-8">
  ...
  return (
    <div className="text-center">
      ...
      <p className="mt-2 text-base text-[#71717A]">
        Sign in with Google to join this bootcamp and get your assignments.
      </p>
